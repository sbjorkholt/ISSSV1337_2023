...
The importance of principal components is typically determined by their associated eigenvalues. Higher eigenvalues[^3] indicate more substantial variability explained by the corresponding principal component. Therefore, the eigenvalues serve as a measure of the relative importance of each component in the data representation. So then, how can we do this?

[^3]: The what you say? Here I'm going to let our favourite AI explain it. I could also recomend 3Blue1Browns video, chapter 14 in his series on linear algebra:\
    \

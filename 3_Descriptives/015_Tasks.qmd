...
You can download the script and fill it out directly in R. Download the script from [here](https://drive.google.com/file/d/1dsCtjsedVrF4dkftaUKV1rH96SBPzX0-/view?usp=sharing).
...
```{r, out.width="100%", echo = FALSE, fig.show="hold", eval = TRUE}

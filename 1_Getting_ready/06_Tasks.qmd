...
19. For all chucks where you do not want to show messages, errors and warnings when executing code, add one or more of the following to the chuck: warning=FALSE, error=FALSE, message=FALSE. Like so:

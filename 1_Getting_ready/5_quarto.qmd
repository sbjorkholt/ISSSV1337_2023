...
For more settings, this [webpage](https://quarto.org/docs/authoring/markdown-basics.html). The best way to learn is to just start and look up things as you need them.

...
In this table we see the difference between observed continents and predicted continents. We can see that our model predicted 393 of Africa, however, for 68 Africas, our model predicted Americas. This sounds weird when I write it, but I hope you get the picture. We see how many predicts our model got right and how many it got wrong. We can do the same if we investigate how well our model predicts on new and unseen data (we just plot in the test data instead). This allows us to compare how our model performs on training and on the test data. 

...
Find the script [here](https://drive.google.com/file/d/1oUsTpzvRak0SICwXloVfHiRHYN1TSX5C/view?usp=sharing).
...
3. Download the dataset `global_food_prices.csv` from [here](https://drive.google.com/file/d/1pq5P_0yTApQB1OGiCHzvVlr0-3vxUtpK/view?usp=sharing). If you have a computer that does not have a lot of processing power and struggles with large files, try using the mini-version of the dataset instead, available [here](https://drive.google.com/file/d/1uvsrYZgpvOX-JVCa7vRZzX8Aq35pWTEG/view?usp=sharing). 
